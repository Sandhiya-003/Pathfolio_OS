  ...
  return (
    <div className="w-screen h-screen bg-[#080a0f] flex items-center justify-center p-4 md:p-8 font-sans-clean overflow-hidden">
      ...
      <div className="w-full h-full max-w-[1600px] max-h-[900px] bg-[#0d111a] rounded-3xl border border-slate-800/80 shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-12">
        ...
        <div className="md:col-span-7 relative bg-[#090c13] p-10 md:p-16 flex flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10 my-auto py-8">
            ...
            <p className="text-slate-400 text-base mt-6 max-w-lg leading-relaxed font-light">
              Create your sovereign identity node, organize your achievements, and take control of your career journey.
            </p>
          </div>
        ...
        {/* Right Form Section (5 Columns) */}
        <div className="md:col-span-5 p-10 md:p-16 flex flex-col justify-between bg-[#111622] border-l border-slate-800/50 overflow-y-auto">
          ...
          <div className="my-auto max-w-md w-full mx-auto py-4">
            ...
            <p className="text-xs text-slate-400 mt-2 font-light">
              Create your secure identity node.
            </p>
            ...
            <form onSubmit={onSubmit} className="mt-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#090c13] border border-slate-800 rounded-xl px-4 py-2.5 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-amber-500/80 transition-all"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="alexander@archive.io"
                  className="w-full bg-[#090c13] border border-slate-800 rounded-xl px-4 py-2.5 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-amber-500/80 transition-all"
                  required
                />
              </div>
              ...
              <div>
                <label className="block text-xs font-medium text-slate-400 mb-1.5">
                  Digital Identifier (Username)
                </label>
                <input
                  type="text"
                  value={form.username}
                  onChange={update('username')}
                  placeholder="@athorne_01"
                  className="w-full bg-[#090c13] border border-slate-800 rounded-xl px-4 py-2.5 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:border-amber-500/80 transition-all"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-semibold py-3 rounded-xl text-xs uppercase tracking-widest transition-all shadow-lg shadow-amber-500/10 mt-3 disabled:opacity-50"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                type="button"
                className="flex items-center justify-center gap-2.5 bg-[#090c13] border border-slate-800 hover:border-slate-700 text-slate-300 py-2.5 rounded-xl text-xs transition-all"
              >
